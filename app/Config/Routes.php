...
$routes->get('activate/resend', 'Auth::resend');
$routes->get('activate/(:segment)', 'HomePublic::activate/$1');
$routes->post('activate/(:segment)', 'HomePublic::activateSubmit/$1');
$routes->post('activate/resend', 'HomePublic::activateResend');
$routes->post('resend', 'HomePublic::activateResend');
...
$routes->post('admin/anggota/toggle', 'Admin::toggleAnggotaStatus');
...
$routes->post('admin/api/simpanan/sukarela/add-by-anggota', 'Admin::apiAddSimpananSukarelaByAnggota');
$routes->post('admin/api/simpanan/sukarela/update', 'Admin::apiUpdateSimpananSukarela');
$routes->post('admin/api/simpanan/sukarela/delete', 'Admin::apiDeleteSimpananSukarela');
$routes->get('admin/api/simpanan/data', 'Admin::apiSimpananData');
$routes->get('admin/api/simpanan/summary', 'Admin::apiSimpananSummary');
$routes->get('admin/api/anggota/search', 'Admin::apiSearchAnggota');
$routes->post('admin/simpanan/sukarela/activate', 'Admin::activateSukarela');
$routes->post('admin/simpanan/sukarela/toggle', 'Admin::toggleSukarelaStatus');
$routes->post('admin/simpanan/wajib/toggle', 'Admin::toggleWajibStatus');
$routes->post('admin/simpanan/pokok/toggle', 'Admin::togglePokokStatus');
$routes->get('admin/setting/waha', 'Admin::settingWaha');
$routes->get('admin/setting/waha/broadcast/(:num)', 'Admin::settingWahaBroadcastDetail/$1');
$routes->get('admin/api/setting/waha', 'Admin::apiSettingWaha');
$routes->get('admin/api/setting/waha/broadcast-history', 'Admin::apiWahaBroadcastHistory');
$routes->get('admin/api/setting/waha/reminder-jobs', 'Admin::apiWahaReminderJobHistory');
$routes->get('admin/api/setting/waha/reminder-jobs/(:num)', 'Admin::apiWahaReminderJobDetail/$1');
$routes->post('admin/api/setting/waha', 'Admin::apiSettingWaha');
$routes->post('admin/api/setting/waha/send-wajib-reminder', 'Admin::apiSendWajibReminder');
$routes->post('admin/api/setting/waha/reminder-jobs/retry-failed', 'Admin::apiWahaReminderJobRetryFailed');
$routes->post('admin/api/setting/waha/broadcast', 'Admin::apiWahaBroadcast');
$routes->get('admin/setting/admin-data', 'Admin::settingAdminData');
$routes->get('admin/api/setting/admin-data', 'Admin::apiSettingAdminData');
$routes->get('admin/setting/admin/add', 'Admin::settingAdminAdd');
$routes->get('admin/setting/admin/edit/(:num)', 'Admin::settingAdminEdit/$1');
$routes->post('admin/setting/admin/add', 'Admin::createAdmin');
$routes->post('admin/setting/admin/edit/(:num)', 'Admin::updateAdmin/$1');
$routes->post('admin/setting/admin/delete/(:num)', 'Admin::deleteAdmin/$1');
$routes->get('admin/api/simpanan/config', 'Admin::apiSimpananConfig');
$routes->post('admin/api/simpanan/config', 'Admin::apiSimpananConfig');
