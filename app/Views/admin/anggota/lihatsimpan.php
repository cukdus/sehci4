<main class="app-main">
  <div class="app-content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6"><h3 class="mb-0">Simpanan <?= esc($anggota['nama'] ?? '-') ?> - <?= esc($anggota['no_anggota'] ?? '-') ?></h3></div>
      </div>
    </div>
  </div>
...
<script>
  (function(){
    ...
    const idAnggota = <?= (int) ($anggota['id_anggota'] ?? 0) ?>;
    function fmt(n){
    ...
    function load(){
      fetch('/admin/api/anggota/'+idAnggota+'/simpanan?page='+page)
        .then(r=>r.json())
        .then(j=>{
    ...
    function loadSummary(){
      fetch('/admin/api/anggota/'+idAnggota+'/simpanan/summary')
        .then(r=>r.json())
        .then(s=>{
