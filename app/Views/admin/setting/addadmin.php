<main class="app-main">
  <div class="app-content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6"><h3 class="mb-0">Tambah Admin/Petugas</h3></div>
        <div class="col-sm-6">
  ...
  <div class="app-content">
    <div class="container-fluid">
      <div class="card card-primary card-outline">
        <div class="card-header"><h5 class="card-title mb-0">Form Tambah</h5></div>
        <div class="card-body">
          <?php $role = (string) (session()->get('user')['role'] ?? ''); ?>
          <?php if ($role !== 'admin'): ?>
            <div class="alert alert-warning mb-0">Hanya admin yang dapat menambahkan admin/petugas.</div>
          <?php else: ?>
            <form method="post" action="/admin/setting/admin/add" class="row g-3" enctype="multipart/form-data">
              <?= csrf_field() ?>
              <div class="col-md-6">
