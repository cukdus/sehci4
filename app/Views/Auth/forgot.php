  ...
  <body class="d-flex align-items-center justify-content-center" style="min-height:100vh;background:#f8f9fb;">
    <div class="card shadow-sm" style="border:0;border-radius:12px;max-width:480px;width:100%;">
      <div class="card-body p-4 p-md-5">
        <h2 class="mb-3 text-center">Lupa Password</h2>
        <p class="text-center text-muted mb-4">Masukkan No. HP</p>
        ...
        <form action="<?= base_url('forgot') ?>" method="post" novalidate>
          <div class="mb-3">
            <label for="username" class="form-label">No. HP atau Email</label>
    ...
    <script>
      (function(){
        var form = document.querySelector('form[action="<?= base_url('forgot') ?>"]');
        if (!form) return;
