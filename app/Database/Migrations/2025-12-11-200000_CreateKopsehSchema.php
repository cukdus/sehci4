...
class CreateKopsehSchema extends Migration
{
    public function up()
    {
        ...
        $this->db->query("CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW v_sisa_pinjaman AS
          SELECT p.id_pinjaman AS id_pinjaman,
                 a.nama AS nama,
                 p.jumlah_pinjaman AS jumlah_pinjaman,
        ...
        $this->db->query("CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW v_total_simpanan_per_anggota AS
          SELECT a.id_anggota AS id_anggota,
                 a.nama AS nama,
